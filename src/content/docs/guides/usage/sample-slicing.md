---
title: Slice and reorder the bits of your samples
---


This page will present you functions that can be used to slice, cut, reverse or explode your samples. Each function will be presented following the same model:
